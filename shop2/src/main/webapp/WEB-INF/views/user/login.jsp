...
<body>
		...
		<form:form modelAttribute="user" method="post" action="login"
			...
			<div class="mb-4">
				...
				<form:input path="userid" class="form-control" id="userid"
					onkeyup="delError()" />
				<div class="error">
					<form:errors path="userid"  id="idError"/>
				</div>
			</div>
			<div class="mb-4">
				...
				<form:password path="password" class="form-control" id="password"
					onkeyup="delError()" />
				<div class="error">
					<form:errors path="password" id="passError"/>
				</div>
			</div>
			<div class="button-group">
				<input type="submit" value="로그인" class="btn btn-primary"> <input
					...
					value="비밀번호찾기" onclick="win_open('pwSearch')"
					class="btn btn-secondary"> <input type="button"
					value="아이디찾기" onclick="win_open('idSearch')"
	...
	<script type="text/javascript">
		function delError(){
			...
			let b = document.querySelector("#idError");
			let c = document.querySelector("#passError");
